...
public:
    ...
    friend class _CLASSTYPE BIH_VectorIteratorImp<T>;
	 ...
	 BIH_VectorImp( const BIH_VectorImp<T>  & );

	 const BIH_VectorImp<T>  & operator = ( const BIH_VectorImp<T>  & );
    ...
    T huge *firstThat( long ( *)(const T  &, void  *),
							  void  *,
                       long,
							  long
                     ) const;

    T huge *firstThat( long ( *cond)(const T  &, void  *),
                       void  *args
                     ) const
        {
	 ...
	 T huge *lastThat( long ( *)(const T &, void  *),
                      void  *,
                      long,
                      long
                    ) const;

	 T huge *lastThat( long ( *cond)(const T &, void  *),
                      void *args
                    ) const
        {
...
template <class T>
BIH_VectorImp<T>::BIH_VectorImp( const BIH_VectorImp<T> & v ) :
	 lim(v.lim)
{
...
template <class T>
const BIH_VectorImp<T> & BIH_VectorImp<T>::operator = ( const BIH_VectorImp<T>  & v )
{
	 if( data != v.data )
		  {
		  GlobalUnlock( h_data );
...
template <class T>
void BIH_VectorImp<T>::forEach( void ( *f)( T  &, void  * ),
										 void  *args,
                               long start,
                               long stop
                             )
...
template <class T>
T huge *BIH_VectorImp<T>::firstThat( long ( *cond)( const T  &, void  * ),
                               void  *args,
                               long start,
                               long stop
                             ) const
...
template <class T>
T huge *BIH_VectorImp<T>::lastThat( long ( *cond)( const T  &, void  * ),
                              void  *args,
                              long start,
                              long stop
                            ) const
...
public:
    ...
    BIH_VectorIteratorImp( const BIH_VectorImp<T> &v )
		  {
        vect = &v;
        restart(0,v.limit());
        }
...
public:
    ...
    T *firstThat( long ( *cond)(const T &, void *),
                       void *args
                     ) const
        {
        return firstThat( cond, args, 0, lim );
    ...
    T *firstThat( long (*)(const T &, void *),
                       void *,
							  long,
                       long
                     ) const;

    T *lastThat( long (*cond)(const T &, void *),
                      void *args
                    ) const
        {
        return lastThat( cond, args, 0, lim );
...
void BIH_InternalIVectorImp<T,Vect>::delObj( T &tRef, void *vect )
{
...
template <class T, class Vect>
void BIH_InternalIVectorImp<T,Vect>::forEach( void ( *f)( T &, void * ),
                                             void *args,
                                             long start,
                                             long stop
                                           )
...
template <class T, class Vect>
T *BIH_InternalIVectorImp<T,Vect>::firstThat( long (*cond)( const T &, void * ),
                                             void *args,
                                             long start,
                                             long stop
                                           ) const
...
template <class T, class Vect>
T *BIH_InternalIVectorImp<T,Vect>::lastThat( long ( *cond)( const T  &, void  * ),
                                            void  *args,
                                            long start,
                                            long stop
                                          ) const
...
template <class T> class _CLASSTYPE BIH_IVectorImp :
    public BIH_InternalIVectorImp<T, BIH_VectorImp<void  *> >
{

public:

    BIH_IVectorImp( long sz ) :
        BIH_InternalIVectorImp<T, BIH_VectorImp<void  *> >(sz)
        {
        }
...
template <class T> class _CLASSTYPE BIH_ICVectorImp :
    public BIH_InternalIVectorImp<T, BIH_CVectorImp<void  *> >
{

public:

    BIH_ICVectorImp( long sz, long d = 0 ) :
        BIH_InternalIVectorImp<T, BIH_CVectorImp<void  *> >(sz)
        {
        delta = d;
        }
...
protected:
    ...
    virtual long find( void  * ) const;

};

template <class T> long BIH_ICVectorImp<T>::find( void  *t ) const
{
    if( limit() != 0 )
        {
...
template <class T > void BIH_ICVectorImp<T>::add( T  *t )
{
    while( count_ < limit() && (*this)[count_] != 0 )
        count_++;
    BIH_InternalIVectorImp<T, BIH_CVectorImp<void  *> >::add(t);
}
...
template <class T> class _CLASSTYPE BIH_ISVectorImp :
    public BIH_InternalIVectorImp<T, BIH_SVectorImp<void  *> >
{

public:

    BIH_ISVectorImp( long sz, long d = 0 ) :
        BIH_InternalIVectorImp<T, BIH_SVectorImp<void  *> >(sz)
        {
        delta = d;
        }
...
template <class T> long BIH_ISVectorImp<T>::find( void  *t ) const
{
	 long lower = 0;
	 long upper = count_-1;
...
template <class T> void BIH_ISVectorImp<T>::add( T  *t )
{
    long loc = count_++;
    if( count_ > lim )
		  resize( count_ );
...
template <class T> class _CLASSTYPE BIH_IVectorIteratorImp :
    public BIH_VectorIteratorImp<void  *>
{

public:

    BIH_IVectorIteratorImp( const BIH_VectorImp<void  *>  &v ) :
        BIH_VectorIteratorImp<void  *>(v)
        {
        bump();
        }
    ...
    BIH_IVectorIteratorImp( const BIH_VectorImp<void  *>  &v,
        ...
        BIH_VectorIteratorImp<void  *>(v,l,u)
        {
        bump();
        }
    ...
    T  *current()
        {
        return (T  *)BIH_VectorIteratorImp<void  *>::current();
        }
    ...
    void restart()
        {
        BIH_VectorIteratorImp<void  *>::restart();
        bump();
        }

	 void restart( long start, long stop )
        {
        BIH_VectorIteratorImp<void  *>::restart( start, stop );
        bump();
        }
...
template <class T> T  * BIH_IVectorIteratorImp<T>::operator ++ ()
{
    BIH_VectorIteratorImp<void  *>::operator++();
    bump();
    return (T  *)current();
}

template <class T> T  * BIH_IVectorIteratorImp<T>::operator ++ ( long )
{
    void *temp = current();
    BIH_VectorIteratorImp<void  *>::operator++(1);
    bump();
    return (T  *)temp;
}
