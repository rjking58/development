...
public:
    ...
    T huge *firstThat( long (*f)(const T &, void *),
                       void huge *args
                     ) const
        {
        if( isEmpty() )
    ...
    T huge *lastThat( long (* f)(const T &, void *),
                      void huge *args
                    ) const
        {
        if( isEmpty() )
...
public:
    ...
    BIH_ArrayAsVectorIterator( const BIH_ArrayAsVector<T>  & a ) :
...
template <class T> class _CLASSTYPE BIH_IArrayAsVector :
    public BIH_ArrayAsVectorImp<BIH_ICVectorImp<T>,T  *>,
...
public:
    ...
    friend class _CLASSTYPE BIH_IArrayAsVectorIterator<T>;
	 ...
	 BIH_IArrayAsVector( long upper, long lower = 0, long delta = 0 ) :
        BIH_ArrayAsVectorImp<BIH_ICVectorImp<T>,T *>( upper, lower, delta )
        {
        }
    ...
    void add( T  *t )
        {
        BIH_ArrayAsVectorImp<BIH_ICVectorImp<T>,T  *>::add(t);
        }

    void addAt( T  *t, long loc )
        {
        BIH_ArrayAsVectorImp<BIH_ICVectorImp<T>,T  *>::addAt(t,loc);
        }
    ...
    T  *firstThat( long ( *f)(const T  &, void  *),
							  void  *args
                     ) const
        {
        if( isEmpty() )
    ...
    T  *lastThat( long ( * f)(const T  &, void  *),
                      void  *args
                    ) const
        {
        if( isEmpty() )
...
public:
	 ...
	 BIH_IArrayAsVectorIterator( const BIH_IArrayAsVector<T>  &a ) :
...
public:
    ...
    BIH_SArrayAsVectorIterator( const BIH_SArrayAsVector<T> & a ) :
        BIH_VectorIteratorImp<T>(a.data) {}
...
template <class T> class _CLASSTYPE BIH_ISArrayAsVector :
    public BIH_ArrayAsVectorImp<BIH_ISVectorImp<T>,T _FAR *>,
    public virtual TShouldDelete
{
...
public:
    ...
    BIH_ISArrayAsVector( long upper, long lower = 0, long delta = 0 ) :
        BIH_ArrayAsVectorImp<BIH_ISVectorImp<T>,T _FAR *>( upper, lower, delta )
        {
        }
    ...
    void add( T *t )
        {
        BIH_ArrayAsVectorImp<BIH_ISVectorImp<T>,T *>::add(t);
        }

    void addAt( T *t, long loc )
        {
        BIH_ArrayAsVectorImp<BIH_ISVectorImp<T>,T *>::addAt(t,loc);
        }
...
public:
	 ...
	 BIH_ISArrayAsVectorIterator( const BIH_ISArrayAsVector<T> _FAR &a ) :
		  BIH_IVectorIteratorImp<T>(a.data) {}
