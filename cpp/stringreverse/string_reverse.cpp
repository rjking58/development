...
ReverseStringErrors ReverseString(char * const strToReverse)
{
   ReverseStringErrors ErrorCode = STRING_REVERSED;
...
void main(void)
{
   ...
   printError(ReverseString((char *)0));
   std::cout << std::endl;
   ...
   std::cout   << "requirements_test before reverse>>" 
               ...
               << "<<" 
               << std::endl;
   printError(ReverseString(requirements_test));
   ...
   std::cout   << "even_length_test before reverse>>" 
               ...
               << "<<" 
               << std::endl;
   printError(ReverseString(even_length_test));
   ...
   std::cout   << "zero_length_test before reverse>>" 
               ...
               << "<<" 
               << std::endl;
   printError(ReverseString(zero_length_test));
   ...
   std::cout   << "one_length_test before reverse>>" 
               ...
               << "<<" 
               << std::endl;
   printError(ReverseString(one_length_test));
