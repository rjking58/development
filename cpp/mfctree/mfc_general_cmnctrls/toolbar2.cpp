...
BEGIN_MESSAGE_MAP(CPaletteBar, CToolBarCtrl)
	...
	ON_NOTIFY_RANGE( TTN_NEEDTEXTA, ID_ERASE, ID_ELLIPSE, OnNeedTextA)
	ON_NOTIFY_RANGE( TTN_NEEDTEXTW, ID_ERASE, ID_ELLIPSE, OnNeedTextW)
	//}}AFX_MSG_MAP
END_MESSAGE_MAP()
...
BOOL CPaletteBar::BeginAdjust(WPARAM wParam, LPARAM lParam, LRESULT* pLResult)
{
	...
	SaveState(HKEY_CURRENT_USER,_T("Software\\Microsoft\\VC40\\Samples\\CtrlDemo"),_T("Palette Tool Bar"));
...
BOOL CPaletteBar::Reset(WPARAM wParam, LPARAM lParam, LRESULT* pLResult)
{
	...
	RestoreState(HKEY_CURRENT_USER,_T("Software\\Microsoft\\VC40\\Samples\\CtrlDemo"),_T("Palette Tool Bar"));
