...
void CSectionForm::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_FieldText(pDX, IDC_SECTIONNO, m_pSet->m_SectionNo, m_pSet);
	DDX_FieldText(pDX, IDC_INSTRUCTORID, m_pSet->m_InstructorID, m_pSet);
	DDX_FieldText(pDX, IDC_ROOMNO, m_pSet->m_RoomNo, m_pSet);
