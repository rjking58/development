...
namespace WorkOutWLANConnectionStuff
{
    enum rcvdMsg
    {
        LAN_CONNECT,
	...
	enum TPPromoteStates
	{
		HARVEST_TP,
		TRY_TO_CONNECT
	};
	enum TPPromoteConnectStates
	{
		SIMPLE_SCAN,
		PROMOTION_SCAN
	};
    enum TPWLANConnectStates
    {
        NOT_CONNECTING,
        IS_SSID_AVAILABLE,
        WAIT_SSID_RESPONSE,
    ...
    struct TPListEntry
    {
        public TPListEntry(string p_tpName,
                    DeviceType p_tpType)
        {
            tpName = p_tpName;
            tpType = p_tpType;
        ...
        public DeviceType tpType;
    }


    class Program
    {
        static TPPromoteStates m_promoteState = TPPromoteStates.HARVEST_TP;
        static TPPromoteConnectStates m_promoteConnectState = TPPromoteConnectStates.SIMPLE_SCAN;
        static TPWLANConnectStates m_WLANConnectStates = TPWLANConnectStates.NOT_CONNECTING;
        static TPWWANConnectStates m_WWANConnectStates = TPWWANConnectStates.NOT_CONNECTING;
        static DeviceType m_connectionDevType = DeviceType.WAN;


        static void DoSimpleConnect(ref bool        stateMachineDone,
